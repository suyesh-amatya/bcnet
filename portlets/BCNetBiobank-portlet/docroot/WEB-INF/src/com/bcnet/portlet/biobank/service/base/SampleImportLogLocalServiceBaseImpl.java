...
import com.bcnet.portlet.biobank.service.SampleImportLogLocalService;
...
/**
 * Provides the base implementation for the sample import log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bcnet.portlet.biobank.service.impl.SampleImportLogLocalServiceImpl}.
 * </p>
 *
 * @author suyama
 ...
 * @generated
 */
public abstract class SampleImportLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SampleImportLogLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.bcnet.portlet.biobank.service.SampleImportLogLocalServiceUtil} to access the sample import log local service.
	 */
	...
	@Override
	public SampleImportLog addSampleImportLog(SampleImportLog sampleImportLog)
		throws SystemException {
		sampleImportLog.setNew(true);

		return sampleImportLogPersistence.update(sampleImportLog);
	}
	 ...
	 */
	@Override
	public SampleImportLog createSampleImportLog(long importId) {
		return sampleImportLogPersistence.create(importId);
	}
	...
	@Override
	public SampleImportLog deleteSampleImportLog(long importId)
		throws PortalException, SystemException {
		return sampleImportLogPersistence.remove(importId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SampleImportLog deleteSampleImportLog(
		SampleImportLog sampleImportLog) throws SystemException {
		return sampleImportLogPersistence.remove(sampleImportLog);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SampleImportLog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return sampleImportLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sampleImportLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SampleImportLog fetchSampleImportLog(long importId)
		throws SystemException {
		return sampleImportLogPersistence.fetchByPrimaryKey(importId);
	}
	 ...
	 */
	@Override
	public SampleImportLog getSampleImportLog(long importId)
		throws PortalException, SystemException {
		return sampleImportLogPersistence.findByPrimaryKey(importId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sampleImportLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SampleImportLog> getSampleImportLogs(int start, int end)
		throws SystemException {
		return sampleImportLogPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSampleImportLogsCount() throws SystemException {
		return sampleImportLogPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SampleImportLog updateSampleImportLog(
		SampleImportLog sampleImportLog) throws SystemException {
		return sampleImportLogPersistence.update(sampleImportLog);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.bcnet.portlet.biobank.model.SampleImportLog",
			sampleImportLogLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = sampleImportLogPersistence.getDataSource();
	...
	private SampleImportLogLocalServiceClpInvoker _clpInvoker = new SampleImportLogLocalServiceClpInvoker();
}