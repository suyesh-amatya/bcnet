...
import com.bcnet.portlet.biobank.service.SampleCollectionLocalService;
...
/**
 * Provides the base implementation for the sample collection local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.bcnet.portlet.biobank.service.impl.SampleCollectionLocalServiceImpl}.
 * </p>
 *
 * @author suyama
 ...
 * @generated
 */
public abstract class SampleCollectionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SampleCollectionLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.bcnet.portlet.biobank.service.SampleCollectionLocalServiceUtil} to access the sample collection local service.
	 */
	...
	@Override
	public SampleCollection addSampleCollection(
		SampleCollection sampleCollection) throws SystemException {
		sampleCollection.setNew(true);

		return sampleCollectionPersistence.update(sampleCollection);
	}
	 ...
	 */
	@Override
	public SampleCollection createSampleCollection(long sampleCollectionDbId) {
		return sampleCollectionPersistence.create(sampleCollectionDbId);
	}
	...
	@Override
	public SampleCollection deleteSampleCollection(long sampleCollectionDbId)
		throws PortalException, SystemException {
		return sampleCollectionPersistence.remove(sampleCollectionDbId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SampleCollection deleteSampleCollection(
		SampleCollection sampleCollection) throws SystemException {
		return sampleCollectionPersistence.remove(sampleCollection);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(SampleCollection.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return sampleCollectionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sampleCollectionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public SampleCollection fetchSampleCollection(long sampleCollectionDbId)
		throws SystemException {
		return sampleCollectionPersistence.fetchByPrimaryKey(sampleCollectionDbId);
	}
	 ...
	 */
	@Override
	public SampleCollection getSampleCollection(long sampleCollectionDbId)
		throws PortalException, SystemException {
		return sampleCollectionPersistence.findByPrimaryKey(sampleCollectionDbId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sampleCollectionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SampleCollection> getSampleCollections(int start, int end)
		throws SystemException {
		return sampleCollectionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSampleCollectionsCount() throws SystemException {
		return sampleCollectionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SampleCollection updateSampleCollection(
		SampleCollection sampleCollection) throws SystemException {
		return sampleCollectionPersistence.update(sampleCollection);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.bcnet.portlet.biobank.model.SampleCollection",
			sampleCollectionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = sampleCollectionPersistence.getDataSource();
	...
	private SampleCollectionLocalServiceClpInvoker _clpInvoker = new SampleCollectionLocalServiceClpInvoker();
}