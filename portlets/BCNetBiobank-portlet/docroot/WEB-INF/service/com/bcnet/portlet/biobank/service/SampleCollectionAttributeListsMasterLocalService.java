...
/**
 * Provides the local service interface for SampleCollectionAttributeListsMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author suyama
 * @see SampleCollectionAttributeListsMasterLocalServiceUtil
...
public interface SampleCollectionAttributeListsMasterLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SampleCollectionAttributeListsMasterLocalServiceUtil} to access the sample collection attribute lists master local service. Add custom service methods to {@link com.bcnet.portlet.biobank.service.impl.SampleCollectionAttributeListsMasterLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
