 ...
 * @generated
 */
public abstract class SampleImportLogActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SampleImportLogActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SampleImportLogLocalServiceUtil.getService());
		setClass(SampleImportLog.class);

		setClassLoader(com.bcnet.portlet.biobank.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("importId");
	}
}