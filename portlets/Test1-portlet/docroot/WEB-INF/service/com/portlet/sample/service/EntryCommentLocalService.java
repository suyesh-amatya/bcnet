...
/**
 * Provides the local service interface for EntryComment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Scalsysu5
 * @see EntryCommentLocalServiceUtil
...
public interface EntryCommentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EntryCommentLocalServiceUtil} to access the entry comment local service. Add custom service methods to {@link com.portlet.sample.service.impl.EntryCommentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
