...
/**
 * Provides the local service interface for RDConnectIDCardMolgenis. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author suyeshamatya
 * @see RDConnectIDCardMolgenisLocalServiceUtil
...
public interface RDConnectIDCardMolgenisLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RDConnectIDCardMolgenisLocalServiceUtil} to access the r d connect i d card molgenis local service. Add custom service methods to {@link com.rdconnect.org.idcardmolgenis.service.impl.RDConnectIDCardMolgenisLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
